...
function Header() {
  return (
    <header className='z-[999] relative'>
      ...
      <nav className='flex fixed top-[0.15] left-1/2 h-12
      -translate-x-1/2 py-2 sm:top-[1.7rem] sm:h-[initail] sm:py-0'>
        ...
        font-medium text-gray-500 sm:w-[initial] sm:flex-nowrap sm:gap-5'>
          {links.map((e) => (
            <motion.li 
              ...
              hover:text-gray-950 transition'href={e.hash}>{e.name}
              </Link>
            </motion.li>
          ))}
        </ul>
